...
export const DEFAULT_PROMPTS = {
  ...
  ask: "Answer the question using only the provided Hits. Cite each Hit as [Hit: videoId @ seconds] using that Hit's Video id, never a label such as video, session, or course. Write in the requested Output language."
}
